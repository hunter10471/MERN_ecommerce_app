  ...
  return (
    <div className='flex m-4'>
      <section className='mx-2 text-sm md:text-base z-10 relative'>
        ...
        />
        <select
          className='appearance-none cursor-pointer hover:shadow-xl bg-slate-800 focus:outline-none  text-white font-light border-white border-[1px] rounded-sm w-[120px] py-1 px-2 text-left'
          name='language'
          id=''
        >
