  ...
  return (
    <div>
     { user ? <Button
      ...
      { logoutModal && <span className='w-[250px] bg-green-300 z-[999] border-green-500 border-2 py-2 px-6 rounded-md text-xs mb-2 md:text-sm text-center absolute bottom-0 left-[calc(50%_-_115px)] '>Logged out successfully. <CloseOutlined onClick={()=>setLogoutModal(false)} fontSize='' className='absolute top-1 right-1 cursor-pointer' /></span>}
    </div>
  );
}
