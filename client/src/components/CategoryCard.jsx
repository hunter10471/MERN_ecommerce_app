...
export const CategoryCard = ({title, bgColor, img, desc}) => {
  ...
  return (
    <div style={{backgroundColor:`${bgColor}`}} className={`transition-all duration-200 hover:scale-[1.08] rounded-md text-secondary pb-4 flex-shrink-0 m-1 sm:m-4 shadow-xl `}>
