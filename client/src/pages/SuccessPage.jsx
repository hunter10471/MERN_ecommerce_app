...
export const SuccessPage = () => {
  return (
    <div className='w-full h-[80vh] flex flex-col items-center justify-center'>
        ...
        <Link to='/orders'><span className='flex items-center underline text-blue-600 text-sm sm:text-base my-2 font-thin px-5 sm:mx-10 md:px-20'><KeyboardBackspaceIcon className='mr-2' fontSize='medium' />Show my orders</span></Link>
    </div>
  )
}
