    ...
    <div className='px-2 pr-4 my-10'>
        ...
        <div className='flex flex-col my-10 lg:my-0 self-center max-w-[400px] w-[80%]'>
                ...
                <div className='flex flex-col p-4 lg:p-6  bg-gray-100 mt-2'>
                    ...
                    <span className='font-medium text-sm flex justify-between items-center '>$80 <Link to='/billing'><button className='py-2 px-6 transition-all bg-primary hover:bg-primaryLight text-white rounded-sm'>Checkout</button> </Link></span>
                </div>
            </div>
        </div>
    </div>
