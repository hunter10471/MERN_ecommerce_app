...
export const Register = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex shadow-xl bg-white flex-col ring-primaryLight ring-2 rounded-sm p-5 sm:p-10 mx-auto' >
        ...
        <input type='email'  required onChange={(e)=>setEmail(e.target.value)} className='placeholder:italic hover:bg-slate-100 ring-slate-300 hover:ring-blue-400 my-2 sm:my-4 text-sm md:text-md  px-2 sm:px-4 min-w-[200px] py-2 focus:outline-none focus:ring-blue-400 ring-2 ring-transparent' placeholder='Email' />
        ...
        <input required onChange={(e)=>setConfirmPassword(e.target.value)} className='placeholder:italic hover:bg-slate-100 w-full ring-slate-300 hover:ring-blue-400 my-2 sm:my-4 text-sm md:text-md  px-2 sm:px-4 min-w-[200px] py-2 focus:outline-none focus:ring-blue-400 ring-2 ring-transparent' type={visiblePassword2 === true ? 'text' : 'password'} placeholder='Confirm Password' />
        </div>
